...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='/home/fuji/Data/Model/DAM-3B-Video', help='Path to the model checkpoint')
    ...
    sam2_checkpoint = "/home/fuji/PycharmProjects/sam2/checkpoints/sam2.1_hiera_large.pt"
